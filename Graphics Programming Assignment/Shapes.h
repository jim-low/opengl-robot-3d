...
public:
	...
	static void drawCuboid(Vector3 startPoint, float width, float height, float length);
	static void drawCube(Vector3 p1, Vector3 p2, Vector3 p3, Vector3 p4, Vector3 p5, Vector3 p6, Vector3 p7, Vector3 p8);
};
