...
public:
	...
	static void drawSphereWithTexture(GLdouble radius, GLint slices, GLint stacks, GLenum drawStyle);
	...
	static void drawPlane(Vector3 p1, Vector3 p2, Vector3 p3, Vector3 p4, GLenum glBeginMode);
};
